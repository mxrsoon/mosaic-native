...
TNode<Object> RegExpPrototypeMatchBody_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_regexp, TNode<String> p_string, bool p_isFastPath) {
  ...
  if (block28.is_used()) {
    ...
    ca_.Branch(tmp30, &block22, std::vector<Node*>{}, &block23, std::vector<Node*>{tmp10, tmp11});
  }
  ...
  if (block22.is_used()) {
    ...
    ca_.Branch(tmp37, &block35, std::vector<Node*>{}, &block36, std::vector<Node*>{});
  }
  ...
  if (block40.is_used()) {
    ...
    ca_.Branch(tmp45, &block38, std::vector<Node*>{phi_bb40_5, phi_bb40_6, phi_bb40_7, phi_bb40_8, phi_bb40_9}, &block39, std::vector<Node*>{phi_bb40_5, phi_bb40_6, phi_bb40_7, phi_bb40_8, phi_bb40_9});
  }
  ...
  if (block51.is_used()) {
    ...
    tmp54 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kSubString, p_context, p_string, tmp52, tmp53));
  ...
  if (block46.is_used()) {
    ...
    ca_.Branch(tmp57, &block57, std::vector<Node*>{phi_bb46_5, phi_bb46_6, phi_bb46_7, phi_bb46_8, phi_bb46_9}, &block58, std::vector<Node*>{phi_bb46_5, phi_bb46_6, phi_bb46_7, phi_bb46_8, phi_bb46_9});
  }
  ...
  if (block47.is_used()) {
    ...
    ca_.Branch(tmp61, &block83, std::vector<Node*>{phi_bb47_5, phi_bb47_6, phi_bb47_7, phi_bb47_8, phi_bb47_9, phi_bb47_10, phi_bb47_10, phi_bb47_10}, &block84, std::vector<Node*>{phi_bb47_5, phi_bb47_6, phi_bb47_7, phi_bb47_8, phi_bb47_9, phi_bb47_10, phi_bb47_10, phi_bb47_10});
  }
  ...
  if (block44.is_used()) {
    ...
    ca_.Branch(tmp63, &block59, std::vector<Node*>{phi_bb44_5, phi_bb44_6, phi_bb44_7, phi_bb44_8, phi_bb44_9}, &block60, std::vector<Node*>{phi_bb44_5, phi_bb44_6, phi_bb44_7, phi_bb44_8, phi_bb44_9});
  }
  ...
  if (block84.is_used()) {
    ...
    ca_.Branch(tmp85, &block102, std::vector<Node*>{phi_bb84_8, phi_bb84_9, phi_bb84_10, phi_bb84_11, phi_bb84_12, phi_bb84_7, phi_bb84_7, phi_bb84_7, phi_bb84_7}, &block103, std::vector<Node*>{phi_bb84_8, phi_bb84_9, phi_bb84_10, phi_bb84_11, phi_bb84_12, phi_bb84_7, phi_bb84_7, phi_bb84_7, phi_bb84_7});
  }
  ...
  if (block102.is_used()) {
    ...
    ca_.Branch(tmp92, &block105, std::vector<Node*>{phi_bb102_8, phi_bb102_9, phi_bb102_10}, &block106, std::vector<Node*>{phi_bb102_8, phi_bb102_9, phi_bb102_10});
  }
  ...
  if (block114.is_used()) {
    ...
    tmp97 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprUintPtrLessThan(String::kMaxLength, kSmiMaxValue)));
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp97}, "static_assert(kMaxStringLengthFitsSmi) at src/builtins/regexp-match.tq:113:9");
...
TF_BUILTIN(RegExpMatchFast, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<JSRegExp> parameter1 = UncheckedParameter<JSRegExp>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  TNode<String> parameter2 = UncheckedParameter<String>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
