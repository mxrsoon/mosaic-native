...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp8, &block9, std::vector<Node*>{phi_bb11_11}, &block10, std::vector<Node*>{phi_bb11_11});
  }
  ...
  if (block9.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).CallBuiltin(Builtins::kFastCreateDataProperty, parameter0, phi_bb5_10, phi_bb9_11, tmp10);
