...
tmp26 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp19, TNode<Object>(), tmp25, phi_bb19_16));
  ...
  if (block31.is_used()) {
    ...
    ca_.Branch(tmp45, &block49, std::vector<Node*>{phi_bb31_16, phi_bb31_12, phi_bb31_12, phi_bb31_12, phi_bb31_12}, &block50, std::vector<Node*>{phi_bb31_16, phi_bb31_12, phi_bb31_12, phi_bb31_12, phi_bb31_12});
  }
