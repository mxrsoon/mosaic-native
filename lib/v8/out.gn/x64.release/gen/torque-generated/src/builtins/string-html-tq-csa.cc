...
TF_BUILTIN(CreateHTML, CodeStubAssembler) {
  ...
  USE(parameter2);
  TNode<String> parameter3 = UncheckedParameter<String>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  TNode<String> parameter4 = UncheckedParameter<String>(Descriptor::ParameterIndex<3>());
  USE(parameter4);
