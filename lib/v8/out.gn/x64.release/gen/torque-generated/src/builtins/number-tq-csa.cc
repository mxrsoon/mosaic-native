...
TNode<String> NumberToStringSmi_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_x, TNode<Int32T> p_radix, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp31, &block32, std::vector<Node*>{phi_bb25_4, phi_bb25_5, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7}, &block33, std::vector<Node*>{phi_bb25_4, phi_bb25_5, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7});
  }
  ...
  if (block35.is_used()) {
    ...
    ca_.Branch(tmp47, &block46, std::vector<Node*>{phi_bb35_3, phi_bb35_4, phi_bb35_5, phi_bb35_7}, &block47, std::vector<Node*>{phi_bb35_3, phi_bb35_4, phi_bb35_5, phi_bb35_7});
  }
  ...
  if (block36.is_used()) {
    ...
    ca_.Branch(tmp56, &block53, std::vector<Node*>{phi_bb36_3, phi_bb36_4, phi_bb36_5, phi_bb36_7}, &block54, std::vector<Node*>{phi_bb36_3, phi_bb36_4, phi_bb36_5, phi_bb36_7});
  }
