...
TF_BUILTIN(GenericBuiltinTest_JSAny_0, CodeStubAssembler) {
  ...
  TNode<Object> parameter0 = UncheckedParameter<Object>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(TestHelperPlus1, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<Smi> parameter0 = UncheckedParameter<Smi>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
void TestSlices_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp23, &block8, std::vector<Node*>{}, &block9, std::vector<Node*>{});
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Branch(tmp40, &block18, std::vector<Node*>{}, &block19, std::vector<Node*>{});
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp47, &block23, std::vector<Node*>{}, &block24, std::vector<Node*>{});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp53, &block26, std::vector<Node*>{}, &block27, std::vector<Node*>{});
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp61, &block34, std::vector<Node*>{}, &block35, std::vector<Node*>{});
  }
  ...
  if (block34.is_used()) {
    ...
    ca_.Branch(tmp67, &block28, std::vector<Node*>{}, &block29, std::vector<Node*>{});
  }
...
TNode<Oddball> TestSliceEnumeration_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp10, &block12, std::vector<Node*>{phi_bb2_2, phi_bb2_2, phi_bb2_2, phi_bb2_2, phi_bb2_2}, &block13, std::vector<Node*>{phi_bb2_2, phi_bb2_2, phi_bb2_2, phi_bb2_2, phi_bb2_2});
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Branch(tmp18, &block6, std::vector<Node*>{phi_bb12_2}, &block7, std::vector<Node*>{phi_bb12_2});
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp24, &block19, std::vector<Node*>{phi_bb6_2, phi_bb6_2, phi_bb6_2, phi_bb6_2, phi_bb6_2}, &block20, std::vector<Node*>{phi_bb6_2, phi_bb6_2, phi_bb6_2, phi_bb6_2, phi_bb6_2});
  }
  ...
  if (block24.is_used()) {
    ...
    ca_.Branch(tmp38, &block22, std::vector<Node*>{phi_bb24_5}, &block23, std::vector<Node*>{phi_bb24_5});
  }
  ...
  if (block22.is_used()) {
    ...
    ca_.Branch(tmp41, &block29, std::vector<Node*>{phi_bb22_5, phi_bb22_5, phi_bb22_5}, &block30, std::vector<Node*>{phi_bb22_5, phi_bb22_5, phi_bb22_5});
  }
  ...
  if (block29.is_used()) {
    ...
    ca_.Branch(tmp51, &block32, std::vector<Node*>{phi_bb29_5}, &block33, std::vector<Node*>{phi_bb29_5});
  }
  ...
  if (block37.is_used()) {
    ...
    ca_.Branch(tmp59, &block35, std::vector<Node*>{phi_bb37_6, phi_bb37_8}, &block36, std::vector<Node*>{phi_bb37_6, phi_bb37_8});
  }
  ...
  if (block35.is_used()) {
    ...
    ca_.Branch(tmp60, &block42, std::vector<Node*>{phi_bb35_6, phi_bb35_8}, &block43, std::vector<Node*>{phi_bb35_6, phi_bb35_8});
  }
  ...
  if (block43.is_used()) {
    ...
    ca_.Branch(tmp69, &block46, std::vector<Node*>{phi_bb43_8}, &block47, std::vector<Node*>{phi_bb43_8});
  }
  ...
  if (block36.is_used()) {
    ...
    ca_.Branch(tmp73, &block48, std::vector<Node*>{phi_bb36_6, phi_bb36_8}, &block49, std::vector<Node*>{phi_bb36_6, phi_bb36_8});
  }
  ...
  if (block48.is_used()) {
    ...
    ca_.Branch(tmp74, &block50, std::vector<Node*>{phi_bb48_6, phi_bb48_8}, &block51, std::vector<Node*>{phi_bb48_6, phi_bb48_8});
  }
...
TF_BUILTIN(NewSmiBox, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<Smi> parameter1 = UncheckedParameter<Smi>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
void TestLoadEliminationVariable_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp28, &block13, std::vector<Node*>{}, &block14, std::vector<Node*>{});
  }
  ...
  if (block20.is_used()) {
    ...
    ca_.Branch(tmp58, &block27, std::vector<Node*>{}, &block28, std::vector<Node*>{});
  }
  ...
  if (block27.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp64}, "static_assert(TaggedEqual(v1, v2)) at test/torque/test-torque.tq:959:3");
    tmp65 = CodeStubAssembler(state_).TaggedEqual(TNode<MaybeObject>{tmp33}, TNode<MaybeObject>{tmp63});
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp65}, "static_assert(TaggedEqual(u1, u2)) at test/torque/test-torque.tq:960:3");
    ca_.Goto(&block30);
  }
...
TNode<Smi> TestRedundantArrayElementCheck_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp11, &block12, std::vector<Node*>{phi_bb2_2, phi_bb2_2, phi_bb2_2}, &block13, std::vector<Node*>{phi_bb2_2, phi_bb2_2, phi_bb2_2});
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp25, &block21, std::vector<Node*>{phi_bb6_2, phi_bb6_2, phi_bb6_2}, &block22, std::vector<Node*>{phi_bb6_2, phi_bb6_2, phi_bb6_2});
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Branch(tmp32, &block15, std::vector<Node*>{phi_bb21_2}, &block16, std::vector<Node*>{phi_bb21_2});
  }
  ...
  if (block16.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp34}, "static_assert(false) at test/torque/test-torque.tq:971:9");
...
void TestOffHeapSlice_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_ptr, TNode<IntPtrT> p_length) {
  ...
  if (block0.is_used()) {
    ...
    tmp10 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp7});
    tmp11 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp9}, TNode<UintPtrT>{tmp10});
    ca_.Branch(tmp11, &block21, std::vector<Node*>{}, &block22, std::vector<Node*>{});
  }
  ...
  if (block16.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"test/torque/test-torque.tq", 1348});
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp25, &block24, std::vector<Node*>{phi_bb26_9}, &block25, std::vector<Node*>{phi_bb26_9});
  }
  ...
  if (block24.is_used()) {
    ...
    tmp28 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp26}, TNode<UintPtrT>{tmp27});
    ca_.Branch(tmp28, &block34, std::vector<Node*>{phi_bb24_9, phi_bb24_9, phi_bb24_9, phi_bb24_9, phi_bb24_9}, &block35, std::vector<Node*>{phi_bb24_9, phi_bb24_9, phi_bb24_9, phi_bb24_9, phi_bb24_9});
  }
  ...
  if (block34.is_used()) {
    ...
    ca_.Branch(tmp36, &block41, std::vector<Node*>{phi_bb34_9, phi_bb34_9, phi_bb34_9, phi_bb34_9, phi_bb34_9}, &block42, std::vector<Node*>{phi_bb34_9, phi_bb34_9, phi_bb34_9, phi_bb34_9, phi_bb34_9});
  }
  ...
  if (block41.is_used()) {
    ...
    ca_.Branch(tmp42, &block28, std::vector<Node*>{phi_bb41_9}, &block29, std::vector<Node*>{phi_bb41_9});
  }
  ...
  if (block29.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"test/torque/test-torque.tq", 1353});
...
TorqueStructSlice_Smi_MutableReference_Smi_0 FieldSliceInternalClassWithSmiElementsEntries_0(compiler::CodeAssemblerState* state_, TNode<InternalClassWithSmiElements> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{p_o, tmp1});
    tmp3 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp2});
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    std::tie(tmp5, tmp6, tmp7) = NewMutableSlice_Smi_0(state_, TNode<Object>{p_o}, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp3}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_Smi_MutableReference_Smi_0{TNode<Object>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7}, TorqueStructUnsafe_0{}};
}
...
TorqueStructSlice_InternalClassStructElement_MutableReference_InternalClassStructElement_0 FieldSliceInternalClassWithStructElementsMoreEntries_0(compiler::CodeAssemblerState* state_, TNode<InternalClassWithStructElements> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{p_o, tmp7});
    tmp9 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp8});
    std::tie(tmp10, tmp11, tmp12) = NewMutableSlice_InternalClassStructElement_0(state_, TNode<Object>{p_o}, TNode<IntPtrT>{tmp5}, TNode<IntPtrT>{tmp9}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_InternalClassStructElement_MutableReference_InternalClassStructElement_0{TNode<Object>{tmp10}, TNode<IntPtrT>{tmp11}, TNode<IntPtrT>{tmp12}, TorqueStructUnsafe_0{}};
}
...
void InitializeFieldsFromIterator_Object_TestIterator_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_Object_MutableReference_Object_0 p_target, TorqueStructTestIterator_0 p_originIterator) {
  ...
  if (block5.is_used()) {
    ...
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp2, &block3, std::vector<Node*>{phi_bb5_5, phi_bb5_7}, &block4, std::vector<Node*>{phi_bb5_5, phi_bb5_7});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp3, &block9, std::vector<Node*>{phi_bb3_5, phi_bb3_7}, &block10, std::vector<Node*>{phi_bb3_5, phi_bb3_7});
  }
