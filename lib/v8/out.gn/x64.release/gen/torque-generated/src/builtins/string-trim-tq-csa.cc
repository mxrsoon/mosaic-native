...
TNode<BoolT> IsWhiteSpaceOrLineTerminator_0(compiler::CodeAssemblerState* state_, TNode<Uint16T> p_charCode) {
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(tmp14, &block8, std::vector<Node*>{}, &block9, std::vector<Node*>{});
  }
  ...
  if (block13.is_used()) {
    ...
    ca_.Branch(tmp23, &block14, std::vector<Node*>{}, &block15, std::vector<Node*>{});
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Branch(tmp32, &block20, std::vector<Node*>{}, &block21, std::vector<Node*>{});
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Branch(tmp35, &block22, std::vector<Node*>{}, &block23, std::vector<Node*>{});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp38, &block24, std::vector<Node*>{}, &block25, std::vector<Node*>{});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp41, &block26, std::vector<Node*>{}, &block27, std::vector<Node*>{});
  }
  ...
  if (block27.is_used()) {
    ...
    ca_.Branch(tmp44, &block28, std::vector<Node*>{}, &block29, std::vector<Node*>{});
  }
...
TNode<String> StringTrim_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TorqueStructArguments p__arguments, const char* p_methodName, String::TrimMode p_variant) {
  ...
  if (block8.is_used()) {
    ...
    ca_.Branch(tmp6, &block6, std::vector<Node*>{phi_bb8_8, phi_bb8_9}, &block7, std::vector<Node*>{phi_bb8_8, phi_bb8_9});
  }
...
TNode<String> StringTrimBody_char8_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<String> p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_slice, String::TrimMode p_variant) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Branch(tmp4, &block2, std::vector<Node*>{}, &block3, std::vector<Node*>{tmp1});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp9, &block6, std::vector<Node*>{phi_bb3_6}, &block7, std::vector<Node*>{phi_bb3_6, tmp3});
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp14, &block8, std::vector<Node*>{phi_bb6_6}, &block9, std::vector<Node*>{phi_bb6_6});
  }
...
TNode<IntPtrT> StringTrimLoop_char8_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructSlice_char8_ConstReference_char8_0 p_stringSlice, TNode<IntPtrT> p_startIndex, TNode<IntPtrT> p_endIndex, TNode<IntPtrT> p_increment) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp0, &block2, std::vector<Node*>{phi_bb4_7}, &block3, std::vector<Node*>{phi_bb4_7});
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp1, &block5, std::vector<Node*>{phi_bb2_7}, &block6, std::vector<Node*>{phi_bb2_7});
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp4, &block11, std::vector<Node*>{phi_bb6_7, phi_bb6_7, phi_bb6_7, phi_bb6_7, phi_bb6_7}, &block12, std::vector<Node*>{phi_bb6_7, phi_bb6_7, phi_bb6_7, phi_bb6_7, phi_bb6_7});
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp11, &block14, std::vector<Node*>{phi_bb11_7}, &block15, std::vector<Node*>{phi_bb11_7});
  }
