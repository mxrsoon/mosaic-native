...
USE(parameter1);
  ...
  if (block24.is_used()) {
    ...
    ca_.Branch(tmp40, &block30, std::vector<Node*>{}, &block31, std::vector<Node*>{});
  }
  ...
  if (block30.is_used()) {
    ...
    ca_.Branch(tmp49, &block37, std::vector<Node*>{}, &block38, std::vector<Node*>{});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp60, &block43, std::vector<Node*>{}, &block44, std::vector<Node*>{});
  }
