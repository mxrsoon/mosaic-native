...
TF_BUILTIN(NewSloppyArgumentsElements, CodeStubAssembler) {
  ...
  TNode<RawPtrT> parameter0 = UncheckedParameter<RawPtrT>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<IntPtrT> parameter1 = UncheckedParameter<IntPtrT>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  TNode<Smi> parameter2 = UncheckedParameter<Smi>(Descriptor::ParameterIndex<2>());
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TorqueStructReference_Object_0 AccessSloppyArgumentsCommon_0(compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block20.is_used()) {
    ...
    ca_.Branch(tmp31, &block26, std::vector<Node*>{}, &block27, std::vector<Node*>{});
  }
  ...
  if (block32.is_used()) {
    ...
    ca_.Branch(tmp42, &block33, std::vector<Node*>{}, &block34, std::vector<Node*>{});
  }
  ...
  if (block34.is_used()) {
    ...
    ca_.Branch(tmp49, &block41, std::vector<Node*>{}, &block42, std::vector<Node*>{});
  }
  ...
  if (block41.is_used()) {
    ...
    ca_.Branch(tmp56, &block35, std::vector<Node*>{}, &block36, std::vector<Node*>{});
  }
  ...
  if (block36.is_used()) {
    ...
    ca_.Branch(tmp63, &block48, std::vector<Node*>{}, &block49, std::vector<Node*>{});
  }
...
TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 FieldSliceSloppyArgumentsElementsMappedEntries_0(compiler::CodeAssemblerState* state_, TNode<SloppyArgumentsElements> p_o) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp5, tmp6, tmp7) = NewMutableSlice_Smi_OR_TheHole_0(state_, TNode<Object>{p_o}, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp3}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0{TNode<Object>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7}, TorqueStructUnsafe_0{}};
}
...
void InitializeFieldsFromIterator_Smi_OR_TheHole_ParameterMapIterator_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 p_target, TorqueStructParameterMapIterator_0 p_originIterator) {
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp2, &block3, std::vector<Node*>{phi_bb5_6, phi_bb5_8}, &block4, std::vector<Node*>{phi_bb5_6, phi_bb5_8});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp3, &block9, std::vector<Node*>{phi_bb3_6, phi_bb3_8}, &block10, std::vector<Node*>{phi_bb3_6, phi_bb3_8});
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp8, &block16, std::vector<Node*>{phi_bb10_8}, &block17, std::vector<Node*>{phi_bb10_8});
  }
