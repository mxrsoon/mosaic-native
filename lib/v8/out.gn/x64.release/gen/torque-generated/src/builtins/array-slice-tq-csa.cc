...
TNode<JSArray> HandleFastAliasedSloppyArgumentsSlice_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<JSArgumentsObject> p_args, TNode<Smi> p_start, TNode<Smi> p_count, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp32, &block19, std::vector<Node*>{phi_bb11_12, phi_bb11_15, phi_bb11_15, phi_bb11_15}, &block20, std::vector<Node*>{phi_bb11_12, phi_bb11_15, phi_bb11_15, phi_bb11_15});
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Branch(tmp39, &block22, std::vector<Node*>{phi_bb19_12, phi_bb19_15}, &block23, std::vector<Node*>{phi_bb19_12, phi_bb19_15});
  }
  ...
  if (block22.is_used()) {
    ...
    ca_.Branch(tmp47, &block30, std::vector<Node*>{phi_bb22_12, phi_bb22_15}, &block31, std::vector<Node*>{phi_bb22_12, phi_bb22_15});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp59, &block37, std::vector<Node*>{phi_bb23_12, phi_bb23_15, phi_bb23_15, phi_bb23_15}, &block38, std::vector<Node*>{phi_bb23_12, phi_bb23_15, phi_bb23_15, phi_bb23_15});
  }
