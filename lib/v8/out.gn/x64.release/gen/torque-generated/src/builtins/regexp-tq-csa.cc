...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FlagGetter_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, JSRegExp::Flag::kLinear, v8::Isolate::kRegExpPrototypeOldFlagGetter, "RegExp.prototype.linear");
    CodeStubAssembler(state_).Return(tmp0);
  }
}
