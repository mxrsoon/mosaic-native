...
TF_BUILTIN(ArrayMapLoopContinuation, CodeStubAssembler) {
  ...
  USE(parameter1);
  TNode<JSReceiver> parameter2 = UncheckedParameter<JSReceiver>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  TNode<Object> parameter3 = UncheckedParameter<Object>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  TNode<JSReceiver> parameter4 = UncheckedParameter<JSReceiver>(Descriptor::ParameterIndex<3>());
  USE(parameter4);
  TNode<JSReceiver> parameter5 = UncheckedParameter<JSReceiver>(Descriptor::ParameterIndex<4>());
  USE(parameter5);
  TNode<Number> parameter6 = UncheckedParameter<Number>(Descriptor::ParameterIndex<5>());
  USE(parameter6);
  TNode<Number> parameter7 = UncheckedParameter<Number>(Descriptor::ParameterIndex<6>());
  USE(parameter7);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<JSArray> FastArrayMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_fastO, TNode<Smi> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<JSArray>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_1) {
  ...
  if (block33.is_used()) {
    ...
    ca_.Branch(tmp33, &block39, std::vector<Node*>{phi_bb33_5, phi_bb33_11, phi_bb33_12, phi_bb33_13, phi_bb33_16, phi_bb33_20, phi_bb33_20, phi_bb33_20}, &block40, std::vector<Node*>{phi_bb33_5, phi_bb33_11, phi_bb33_12, phi_bb33_13, phi_bb33_16, phi_bb33_20, phi_bb33_20, phi_bb33_20});
  }
  ...
  if (block45.is_used()) {
    ...
    ca_.Branch(tmp46, &block57, std::vector<Node*>{phi_bb45_5, phi_bb45_13, phi_bb45_16, phi_bb45_20, phi_bb45_20, phi_bb45_20}, &block58, std::vector<Node*>{phi_bb45_5, phi_bb45_13, phi_bb45_16, phi_bb45_20, phi_bb45_20, phi_bb45_20});
  }
  ...
  if (block44.is_used()) {
    ...
    ca_.Branch(tmp54, &block50, std::vector<Node*>{phi_bb44_5, phi_bb44_12, phi_bb44_13, phi_bb44_16, phi_bb44_20, phi_bb44_20, phi_bb44_20}, &block51, std::vector<Node*>{phi_bb44_5, phi_bb44_12, phi_bb44_13, phi_bb44_16, phi_bb44_20, phi_bb44_20, phi_bb44_20});
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp69, &block106, std::vector<Node*>{phi_bb6_5, phi_bb6_7, phi_bb6_11, phi_bb6_12, phi_bb6_13}, &block107, std::vector<Node*>{phi_bb6_5, phi_bb6_7, phi_bb6_11, phi_bb6_12, phi_bb6_13, tmp68});
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp73, &block66, std::vector<Node*>{phi_bb4_5, phi_bb4_7, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_14, phi_bb4_14}, &block67, std::vector<Node*>{phi_bb4_5, phi_bb4_7, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_14, phi_bb4_14, tmp72});
  }
  ...
  if (block72.is_used()) {
    ...
    ca_.Branch(tmp81, &block76, std::vector<Node*>{phi_bb72_5, phi_bb72_7, phi_bb72_11, phi_bb72_12, phi_bb72_13, phi_bb72_14, phi_bb72_15, phi_bb72_18}, &block77, std::vector<Node*>{phi_bb72_5, phi_bb72_7, phi_bb72_11, phi_bb72_12, phi_bb72_13, phi_bb72_14, phi_bb72_15, phi_bb72_18});
  }
  ...
  if (block81.is_used()) {
    ...
    ca_.Branch(tmp86, &block79, std::vector<Node*>{phi_bb81_5, phi_bb81_7, phi_bb81_11, phi_bb81_12, phi_bb81_13, phi_bb81_14, phi_bb81_15, phi_bb81_18, phi_bb81_24}, &block80, std::vector<Node*>{phi_bb81_5, phi_bb81_7, phi_bb81_11, phi_bb81_12, phi_bb81_13, phi_bb81_14, phi_bb81_15, phi_bb81_18, phi_bb81_24});
  }
  ...
  if (block112.is_used()) {
    ...
    ca_.Branch(tmp127, &block116, std::vector<Node*>{phi_bb112_5, phi_bb112_7, phi_bb112_11, phi_bb112_12, phi_bb112_13}, &block117, std::vector<Node*>{phi_bb112_5, phi_bb112_7, phi_bb112_11, phi_bb112_12, phi_bb112_13});
  }
  ...
  if (block121.is_used()) {
    ...
    ca_.Branch(tmp132, &block119, std::vector<Node*>{phi_bb121_5, phi_bb121_7, phi_bb121_11, phi_bb121_12, phi_bb121_13, phi_bb121_23}, &block120, std::vector<Node*>{phi_bb121_5, phi_bb121_7, phi_bb121_11, phi_bb121_12, phi_bb121_13, phi_bb121_23});
  }
  ...
  if (block119.is_used()) {
    ...
    ca_.Branch(tmp139, &block127, std::vector<Node*>{phi_bb119_5, phi_bb119_7, phi_bb119_11, phi_bb119_12, phi_bb119_13, phi_bb119_23, phi_bb119_23, phi_bb119_23}, &block128, std::vector<Node*>{phi_bb119_5, phi_bb119_7, phi_bb119_11, phi_bb119_12, phi_bb119_13, phi_bb119_23, phi_bb119_23, phi_bb119_23});
  }
  ...
  if (block132.is_used()) {
    ...
    ca_.Branch(tmp154, &block138, std::vector<Node*>{phi_bb132_5, phi_bb132_7, phi_bb132_11, phi_bb132_12, phi_bb132_13, phi_bb132_23, phi_bb132_23, phi_bb132_23}, &block139, std::vector<Node*>{phi_bb132_5, phi_bb132_7, phi_bb132_11, phi_bb132_12, phi_bb132_13, phi_bb132_23, phi_bb132_23, phi_bb132_23});
  }
