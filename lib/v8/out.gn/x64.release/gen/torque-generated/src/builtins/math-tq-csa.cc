...
USE(parameter1);
  ...
  if (block8.is_used()) {
    ...
    ca_.Branch(tmp19, &block14, std::vector<Node*>{phi_bb8_7, phi_bb8_8, phi_bb8_9, phi_bb8_9, phi_bb8_9, phi_bb8_9, phi_bb8_9}, &block15, std::vector<Node*>{phi_bb8_7, phi_bb8_8, phi_bb8_9, phi_bb8_9, phi_bb8_9, phi_bb8_9, phi_bb8_9});
  }
  ...
  if (block14.is_used()) {
    ...
    ca_.Branch(tmp26, &block17, std::vector<Node*>{phi_bb14_7, phi_bb14_8, phi_bb14_9}, &block18, std::vector<Node*>{phi_bb14_7, phi_bb14_8, phi_bb14_9});
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp30, &block19, std::vector<Node*>{phi_bb4_7, phi_bb4_8}, &block20, std::vector<Node*>{phi_bb4_7, phi_bb4_8});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp34, &block25, std::vector<Node*>{phi_bb23_7, phi_bb23_8}, &block26, std::vector<Node*>{phi_bb23_7, phi_bb23_8});
  }
  ...
  if (block33.is_used()) {
    ...
    ca_.Branch(tmp39, &block31, std::vector<Node*>{phi_bb33_7, phi_bb33_8, phi_bb33_9, phi_bb33_10, phi_bb33_11}, &block32, std::vector<Node*>{phi_bb33_7, phi_bb33_8, phi_bb33_9, phi_bb33_10, phi_bb33_11});
  }
  ...
  if (block31.is_used()) {
    ...
    ca_.Branch(tmp45, &block39, std::vector<Node*>{phi_bb31_7, phi_bb31_8, phi_bb31_9, phi_bb31_10, phi_bb31_11, phi_bb31_11, phi_bb31_11, phi_bb31_11, phi_bb31_11}, &block40, std::vector<Node*>{phi_bb31_7, phi_bb31_8, phi_bb31_9, phi_bb31_10, phi_bb31_11, phi_bb31_11, phi_bb31_11, phi_bb31_11, phi_bb31_11});
  }
...
USE(parameter1);
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp22, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{});
  }
