...
TF_BUILTIN(CreateTypedArray, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<JSFunction> parameter1 = UncheckedParameter<JSFunction>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  ...
  USE(parameter4);
  TNode<Object> parameter5 = UncheckedParameter<Object>(Descriptor::ParameterIndex<4>());
  USE(parameter5);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
