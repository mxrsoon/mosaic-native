...
USE(parameter1);
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp3, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{});
  }
  ...
  if (block9.is_used()) {
    ...
    ca_.Branch(phi_bb9_7, &block5, std::vector<Node*>{}, &block6, std::vector<Node*>{});
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp18, &block14, std::vector<Node*>{}, &block15, std::vector<Node*>{});
  }
  ...
  if (block32.is_used()) {
    ...
    ca_.Branch(tmp41, &block30, std::vector<Node*>{phi_bb32_9, phi_bb32_15}, &block31, std::vector<Node*>{phi_bb32_9, phi_bb32_15});
  }
  ...
  if (block39.is_used()) {
    ...
    ca_.Branch(phi_bb39_9, &block41, std::vector<Node*>{phi_bb39_9, phi_bb39_15}, &block42, std::vector<Node*>{phi_bb39_9, phi_bb39_15});
  }
  ...
  if (block43.is_used()) {
    ...
    tmp51 = CodeStubAssembler(state_).CallBuiltin(Builtins::kFastCreateDataProperty, parameter0, phi_bb26_11, phi_bb43_15, phi_bb43_18);
    }
  ...
  if (block57.is_used()) {
    ...
    ca_.Branch(tmp59, &block55, std::vector<Node*>{phi_bb57_9, phi_bb57_13}, &block56, std::vector<Node*>{phi_bb57_9, phi_bb57_13});
  }
  ...
  if (block55.is_used()) {
    ...
    ca_.Branch(phi_bb55_9, &block58, std::vector<Node*>{phi_bb55_9, phi_bb55_13}, &block59, std::vector<Node*>{phi_bb55_9, phi_bb55_13});
  }
  ...
  if (block60.is_used()) {
    ...
    tmp63 = CodeStubAssembler(state_).CallBuiltin(Builtins::kFastCreateDataProperty, parameter0, phi_bb51_12, phi_bb60_13, phi_bb60_15);
