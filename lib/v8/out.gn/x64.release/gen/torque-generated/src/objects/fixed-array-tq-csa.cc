...
TorqueStructSlice_Object_MutableReference_Object_0 FieldSliceFixedArrayObjects_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_o) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp5, tmp6, tmp7) = NewMutableSlice_Object_0(state_, TNode<Object>{p_o}, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp3}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_Object_MutableReference_Object_0{TNode<Object>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7}, TorqueStructUnsafe_0{}};
}
...
TorqueStructSlice_uint8_MutableReference_uint8_0 FieldSliceByteArrayBytes_0(compiler::CodeAssemblerState* state_, TNode<ByteArray> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp2});
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    std::tie(tmp5, tmp6, tmp7) = NewMutableSlice_uint8_0(state_, TNode<Object>{p_o}, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp3}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_uint8_MutableReference_uint8_0{TNode<Object>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7}, TorqueStructUnsafe_0{}};
}
...
TorqueStructSlice_MaybeObject_MutableReference_MaybeObject_0 FieldSliceWeakFixedArrayObjects_0(compiler::CodeAssemblerState* state_, TNode<WeakFixedArray> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp2});
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    std::tie(tmp5, tmp6, tmp7) = NewMutableSlice_MaybeObject_0(state_, TNode<Object>{p_o}, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp3}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_MaybeObject_MutableReference_MaybeObject_0{TNode<Object>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7}, TorqueStructUnsafe_0{}};
}
...
TorqueStructSlice_float64_or_hole_MutableReference_float64_or_hole_0 FieldSliceFixedDoubleArrayFloats_0(compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp2});
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    std::tie(tmp5, tmp6, tmp7) = NewMutableSlice_float64_or_hole_0(state_, TNode<Object>{p_o}, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp3}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructSlice_float64_or_hole_MutableReference_float64_or_hole_0{TNode<Object>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7}, TorqueStructUnsafe_0{}};
}
...
TNode<WeakFixedArray> DownCastForTorqueClass_WeakFixedArray_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    tmp1 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{p_o, tmp0});
    if (((CodeStubAssembler(state_).ConstexprInt31Equal(static_cast<InstanceType>(158), static_cast<InstanceType>(159))))) {
      ca_.Goto(&block3);
    } else {
      ca_.Goto(&block4);
    }
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp8 = FromConstexpr_int32_constexpr_int32_0(state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(159), static_cast<InstanceType>(158))));
    tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp9});
    tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T>{tmp10});
    tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T>{tmp11});
...
void InitializeFieldsFromIterator_Object_ArgumentsIterator_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_Object_MutableReference_Object_0 p_target, TorqueStructArgumentsIterator_0 p_originIterator) {
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp2, &block3, std::vector<Node*>{phi_bb5_8, phi_bb5_13}, &block4, std::vector<Node*>{phi_bb5_8, phi_bb5_13});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp3, &block9, std::vector<Node*>{phi_bb3_8, phi_bb3_13}, &block10, std::vector<Node*>{phi_bb3_8, phi_bb3_13});
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp8, &block16, std::vector<Node*>{phi_bb10_13}, &block17, std::vector<Node*>{phi_bb10_13});
  }
...
void InitializeFieldsFromIterator_Object_ParameterValueIterator_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_Object_MutableReference_Object_0 p_target, TorqueStructParameterValueIterator_0 p_originIterator) {
  ...
  if (block5.is_used()) {
    ...
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp2, &block3, std::vector<Node*>{phi_bb5_9, phi_bb5_11, phi_bb5_15}, &block4, std::vector<Node*>{phi_bb5_9, phi_bb5_11, phi_bb5_15});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp3, &block9, std::vector<Node*>{phi_bb3_9, phi_bb3_11, phi_bb3_15}, &block10, std::vector<Node*>{phi_bb3_9, phi_bb3_11, phi_bb3_15});
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp9, &block16, std::vector<Node*>{phi_bb10_11, phi_bb10_15}, &block17, std::vector<Node*>{phi_bb10_11, phi_bb10_15});
  }
  ...
  if (block17.is_used()) {
    ...
    ca_.Branch(tmp13, &block18, std::vector<Node*>{phi_bb17_11, phi_bb17_15}, &block19, std::vector<Node*>{phi_bb17_11, phi_bb17_15});
  }
...
void InitializeFieldsFromIterator_Object_IteratorSequence_Object_SliceIterator_Object_MutableReference_Object_ConstantIterator_TheHole_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_Object_MutableReference_Object_0 p_target, TorqueStructIteratorSequence_Object_SliceIterator_Object_MutableReference_Object_ConstantIterator_TheHole_0 p_originIterator) {
  ...
  if (block5.is_used()) {
    ...
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp2, &block3, std::vector<Node*>{phi_bb5_8, phi_bb5_11}, &block4, std::vector<Node*>{phi_bb5_8, phi_bb5_11});
  }
  ...
  if (block3.is_used()) {
    ...
    tmp3 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb3_8}, TNode<IntPtrT>{tmp1});
    ca_.Branch(tmp3, &block9, std::vector<Node*>{phi_bb3_8, phi_bb3_11}, &block10, std::vector<Node*>{phi_bb3_8, phi_bb3_11});
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp8, &block20, std::vector<Node*>{phi_bb10_11}, &block21, std::vector<Node*>{phi_bb10_11});
  }
...
void InitializeFieldsFromIterator_float64_or_hole_IteratorSequence_float64_or_hole_SliceIterator_float64_or_hole_MutableReference_float64_or_hole_ConstantIterator_float64_or_hole_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_float64_or_hole_MutableReference_float64_or_hole_0 p_target, TorqueStructIteratorSequence_float64_or_hole_SliceIterator_float64_or_hole_MutableReference_float64_or_hole_ConstantIterator_float64_or_hole_0 p_originIterator) {
  ...
  if (block5.is_used()) {
    ...
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp2, &block3, std::vector<Node*>{phi_bb5_9, phi_bb5_12}, &block4, std::vector<Node*>{phi_bb5_9, phi_bb5_12});
  }
  ...
  if (block3.is_used()) {
    ...
    tmp3 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb3_9}, TNode<IntPtrT>{tmp1});
    ca_.Branch(tmp3, &block9, std::vector<Node*>{phi_bb3_9, phi_bb3_12}, &block10, std::vector<Node*>{phi_bb3_9, phi_bb3_12});
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp8, &block20, std::vector<Node*>{phi_bb10_12}, &block21, std::vector<Node*>{phi_bb10_12});
  }
...
void InitializeFieldsFromIterator_Object_ConstantIterator_TheHole_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_Object_MutableReference_Object_0 p_target, TorqueStructConstantIterator_TheHole_0 p_originIterator) {
  ...
  if (block5.is_used()) {
    ...
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp2, &block3, std::vector<Node*>{phi_bb5_5}, &block4, std::vector<Node*>{phi_bb5_5});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp3, &block9, std::vector<Node*>{phi_bb3_5}, &block10, std::vector<Node*>{phi_bb3_5});
  }
