...
TF_BUILTIN(FastNewFunctionContextEval, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<ScopeInfo> parameter1 = UncheckedParameter<ScopeInfo>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  TNode<Uint32T> parameter2 = UncheckedParameter<Uint32T>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
...
TF_BUILTIN(CreateRegExpLiteral, CodeStubAssembler) {
  ...
  USE(parameter1);
  TNode<TaggedIndex> parameter2 = UncheckedParameter<TaggedIndex>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
...
TF_BUILTIN(CreateShallowArrayLiteral, CodeStubAssembler) {
  ...
  TNode<Context> parameter0 = UncheckedParameter<Context>(Descriptor::kContext);
  USE(parameter0);
  TNode<FeedbackVector> parameter1 = UncheckedParameter<FeedbackVector>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  TNode<TaggedIndex> parameter2 = UncheckedParameter<TaggedIndex>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  TNode<ArrayBoilerplateDescription> parameter3 = UncheckedParameter<ArrayBoilerplateDescription>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(CreateShallowObjectLiteral, CodeStubAssembler) {
  ...
  TNode<TaggedIndex> parameter2 = UncheckedParameter<TaggedIndex>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  TNode<ObjectBoilerplateDescription> parameter3 = UncheckedParameter<ObjectBoilerplateDescription>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  TNode<Smi> parameter4 = UncheckedParameter<Smi>(Descriptor::ParameterIndex<3>());
  USE(parameter4);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
