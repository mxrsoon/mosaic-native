...
void TorqueGeneratedClassVerifiers::HeapObjectVerify(HeapObject o, Isolate* isolate) {
  ...
  {
    Object map__value = TaggedField<Object>::load(o, 0);
...
void TorqueGeneratedClassVerifiers::ContextVerify(Context o, Isolate* isolate) {
  ...
  std::tie(std::ignore, elements__offset, elements__length) = TqRuntimeFieldSliceContextElements(isolate, o);
...
void TorqueGeneratedClassVerifiers::FixedArrayVerify(FixedArray o, Isolate* isolate) {
  ...
  std::tie(std::ignore, objects__offset, objects__length) = TqRuntimeFieldSliceFixedArrayObjects(isolate, o);
...
void TorqueGeneratedClassVerifiers::WeakFixedArrayVerify(WeakFixedArray o, Isolate* isolate) {
  ...
  intptr_t objects__offset, objects__length;
  std::tie(std::ignore, objects__offset, objects__length) = TqRuntimeFieldSliceWeakFixedArrayObjects(isolate, o);
  CHECK_EQ(objects__offset, static_cast<int>(objects__offset));
  CHECK_EQ(objects__length, static_cast<int>(objects__length));
  for (int i = 0; i < static_cast<int>(objects__length); ++i) {
...
void TorqueGeneratedClassVerifiers::SloppyArgumentsElementsVerify(SloppyArgumentsElements o, Isolate* isolate) {
  ...
  std::tie(std::ignore, mapped_entries__offset, mapped_entries__length) = TqRuntimeFieldSliceSloppyArgumentsElementsMappedEntries(isolate, o);
...
void TorqueGeneratedClassVerifiers::CoverageInfoVerify(CoverageInfo o, Isolate* isolate) {
  ...
  std::tie(std::ignore, slots__offset, slots__length) = TqRuntimeFieldSliceCoverageInfoSlots(isolate, o);
...
void TorqueGeneratedClassVerifiers::WasmValueVerify(WasmValue o, Isolate* isolate) {
  ...
  CHECK(o.IsWasmValue());
  {
    Object value_type__value = TaggedField<Object>::load(o, 4);
    Object::VerifyPointer(isolate, value_type__value);
    CHECK(value_type__value.IsSmi());
  }
  {
    Object bytes_or_ref__value = TaggedField<Object>::load(o, 8);
...
void TorqueGeneratedClassVerifiers::DescriptorArrayVerify(DescriptorArray o, Isolate* isolate) {
  ...
  std::tie(std::ignore, descriptors__offset, descriptors__length) = TqRuntimeFieldSliceDescriptorArrayDescriptors(isolate, o);
...
void TorqueGeneratedClassVerifiers::FeedbackVectorVerify(FeedbackVector o, Isolate* isolate) {
  ...
  std::tie(std::ignore, raw_feedback_slots__offset, raw_feedback_slots__length) = TqRuntimeFieldSliceFeedbackVectorRawFeedbackSlots(isolate, o);
...
void TorqueGeneratedClassVerifiers::WeakArrayListVerify(WeakArrayList o, Isolate* isolate) {
  ...
  intptr_t objects__offset, objects__length;
  std::tie(std::ignore, objects__offset, objects__length) = TqRuntimeFieldSliceWeakArrayListObjects(isolate, o);
  CHECK_EQ(objects__offset, static_cast<int>(objects__offset));
  CHECK_EQ(objects__length, static_cast<int>(objects__length));
  for (int i = 0; i < static_cast<int>(objects__length); ++i) {
    MaybeObject objects__value = TaggedField<MaybeObject>::load(o, static_cast<int>(objects__offset) + i * kTaggedSize);
...
void TorqueGeneratedClassVerifiers::SmallOrderedHashSetVerify(SmallOrderedHashSet o, Isolate* isolate) {
  ...
  std::tie(std::ignore, data_table__offset, data_table__length) = TqRuntimeFieldSliceSmallOrderedHashSetDataTable(isolate, o);
...
void TorqueGeneratedClassVerifiers::SmallOrderedHashMapVerify(SmallOrderedHashMap o, Isolate* isolate) {
  ...
  intptr_t data_table__offset, data_table__length;
  std::tie(std::ignore, data_table__offset, data_table__length) = TqRuntimeFieldSliceSmallOrderedHashMapDataTable(isolate, o);
  CHECK_EQ(data_table__offset, static_cast<int>(data_table__offset));
  CHECK_EQ(data_table__length, static_cast<int>(data_table__length));
  for (int i = 0; i < static_cast<int>(data_table__length); ++i) {
...
void TorqueGeneratedClassVerifiers::SmallOrderedNameDictionaryVerify(SmallOrderedNameDictionary o, Isolate* isolate) {
  ...
  intptr_t data_table__offset, data_table__length;
  std::tie(std::ignore, data_table__offset, data_table__length) = TqRuntimeFieldSliceSmallOrderedNameDictionaryDataTable(isolate, o);
  CHECK_EQ(data_table__offset, static_cast<int>(data_table__offset));
  CHECK_EQ(data_table__length, static_cast<int>(data_table__length));
  for (int i = 0; i < static_cast<int>(data_table__length); ++i) {
...
void TorqueGeneratedClassVerifiers::ScriptVerify(Script o, Isolate* isolate) {
  ...
  {
    Object eval_from_shared_or_wrapped_arguments__value = TaggedField<Object>::load(o, 36);
...
void TorqueGeneratedClassVerifiers::SourceTextModuleVerify(SourceTextModule o, Isolate* isolate) {
  ...
  {
    Object dfs_index__value = TaggedField<Object>::load(o, 52);
    Object::VerifyPointer(isolate, dfs_index__value);
    CHECK(dfs_index__value.IsSmi());
  }
  {
    Object dfs_ancestor_index__value = TaggedField<Object>::load(o, 56);
    Object::VerifyPointer(isolate, dfs_ancestor_index__value);
    CHECK(dfs_ancestor_index__value.IsSmi());
  }
  {
    Object pending_async_dependencies__value = TaggedField<Object>::load(o, 60);
...
void TorqueGeneratedClassVerifiers::StackFrameInfoVerify(StackFrameInfo o, Isolate* isolate) {
  ...
  {
    Object line_number__value = TaggedField<Object>::load(o, 4);
    Object::VerifyPointer(isolate, line_number__value);
    CHECK(line_number__value.IsSmi());
  }
  {
    Object column_number__value = TaggedField<Object>::load(o, 8);
    Object::VerifyPointer(isolate, column_number__value);
    CHECK(column_number__value.IsSmi());
  }
  {
    Object promise_combinator_index__value = TaggedField<Object>::load(o, 12);
    Object::VerifyPointer(isolate, promise_combinator_index__value);
    CHECK(promise_combinator_index__value.IsSmi());
  }
  {
    Object script_id__value = TaggedField<Object>::load(o, 16);
    Object::VerifyPointer(isolate, script_id__value);
    CHECK(script_id__value.IsSmi());
  }
  {
    Object wasm_function_index__value = TaggedField<Object>::load(o, 20);
    Object::VerifyPointer(isolate, wasm_function_index__value);
    CHECK(wasm_function_index__value.IsSmi());
  }
  {
    Object script_name__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, script_name__value);
  }
  {
    Object script_name_or_source_url__value = TaggedField<Object>::load(o, 28);
    Object::VerifyPointer(isolate, script_name_or_source_url__value);
  }
  {
    Object function_name__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, function_name__value);
    CHECK(function_name__value.IsString() || function_name__value.IsNull() || function_name__value.IsUndefined());
  }
  {
    Object method_name__value = TaggedField<Object>::load(o, 36);
    Object::VerifyPointer(isolate, method_name__value);
    CHECK(method_name__value.IsString() || method_name__value.IsNull() || method_name__value.IsUndefined());
  }
  {
    Object type_name__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, type_name__value);
    CHECK(type_name__value.IsString() || type_name__value.IsNull() || type_name__value.IsUndefined());
  }
  {
    Object eval_origin__value = TaggedField<Object>::load(o, 44);
    Object::VerifyPointer(isolate, eval_origin__value);
    CHECK(eval_origin__value.IsString() || eval_origin__value.IsNull() || eval_origin__value.IsUndefined());
  }
  {
    Object wasm_module_name__value = TaggedField<Object>::load(o, 48);
    Object::VerifyPointer(isolate, wasm_module_name__value);
    CHECK(wasm_module_name__value.IsString() || wasm_module_name__value.IsNull() || wasm_module_name__value.IsUndefined());
  }
  {
    Object wasm_instance__value = TaggedField<Object>::load(o, 52);
  ...
  {
    Object flag__value = TaggedField<Object>::load(o, 56);
...
void TorqueGeneratedClassVerifiers::StackTraceFrameVerify(StackTraceFrame o, Isolate* isolate) {
  ...
  {
    Object frame_array__value = TaggedField<Object>::load(o, 4);
    Object::VerifyPointer(isolate, frame_array__value);
    CHECK(frame_array__value.IsUndefined() || frame_array__value.IsFrameArray());
  }
  {
    Object frame_index__value = TaggedField<Object>::load(o, 8);
    Object::VerifyPointer(isolate, frame_index__value);
    CHECK(frame_index__value.IsSmi());
  }
  {
    Object frame_info__value = TaggedField<Object>::load(o, 12);
...
void TorqueGeneratedClassVerifiers::SyntheticModuleVerify(SyntheticModule o, Isolate* isolate) {
  ...
  {
    Object export_names__value = TaggedField<Object>::load(o, 28);
    Object::VerifyPointer(isolate, export_names__value);
    CHECK(export_names__value.IsFixedArray());
  }
  {
    Object evaluation_steps__value = TaggedField<Object>::load(o, 32);
...
void TorqueGeneratedClassVerifiers::FunctionTemplateRareDataVerify(FunctionTemplateRareData o, Isolate* isolate) {
  ...
  {
    Object c_function__value = TaggedField<Object>::load(o, 36);
    Object::VerifyPointer(isolate, c_function__value);
    CHECK(c_function__value.IsZero() || c_function__value.IsForeign());
  }
  {
    Object c_signature__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, c_signature__value);
    CHECK(c_signature__value.IsZero() || c_signature__value.IsForeign());
  }
}
...
void TorqueGeneratedClassVerifiers::WasmExportedFunctionDataVerify(WasmExportedFunctionData o, Isolate* isolate) {
  ...
  {
    Object wasm_call_target__value = TaggedField<Object>::load(o, 32);
  ...
  {
    Object packed_args_size__value = TaggedField<Object>::load(o, 36);
...
void TorqueGeneratedClassVerifiers::WasmModuleObjectVerify(WasmModuleObject o, Isolate* isolate) {
  ...
  {
    Object native_module__value = TaggedField<Object>::load(o, 12);
...
void TorqueGeneratedClassVerifiers::WasmExceptionObjectVerify(WasmExceptionObject o, Isolate* isolate) {
  ...
  {
    Object exception_tag__value = TaggedField<Object>::load(o, 16);
...
void TorqueGeneratedClassVerifiers::WasmTypeInfoVerify(WasmTypeInfo o, Isolate* isolate) {
  ...
  {
    Object subtypes__value = TaggedField<Object>::load(o, 20);
...
void TorqueGeneratedClassVerifiers::InternalClassWithSmiElementsVerify(InternalClassWithSmiElements o, Isolate* isolate) {
  ...
  std::tie(std::ignore, entries__offset, entries__length) = TqRuntimeFieldSliceInternalClassWithSmiElementsEntries(isolate, o);
...
void TorqueGeneratedClassVerifiers::InternalClassWithStructElementsVerify(InternalClassWithStructElements o, Isolate* isolate) {
  ...
  intptr_t entries__offset, entries__length;
  std::tie(std::ignore, entries__offset, entries__length) = TqRuntimeFieldSliceInternalClassWithStructElementsEntries(isolate, o);
  CHECK_EQ(entries__offset, static_cast<int>(entries__offset));
  CHECK_EQ(entries__length, static_cast<int>(entries__length));
  for (int i = 0; i < static_cast<int>(entries__length); ++i) {
    Object entries__value = TaggedField<Object>::load(o, static_cast<int>(entries__offset) + i * kTaggedSize);
  ...
  std::tie(std::ignore, more_entries__offset, more_entries__length) = TqRuntimeFieldSliceInternalClassWithStructElementsMoreEntries(isolate, o);
