...
TF_BUILTIN(LoadJoinElement_FastSmiOrObjectElements_0, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp17, &block8, std::vector<Node*>{}, &block9, std::vector<Node*>{});
  }
...
TNode<String> BufferJoin_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructBuffer_0 p_buffer, TNode<String> p_sep) {
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    tmp21 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kStringRepeat, p_context, p_sep, tmp19));
...
TF_BUILTIN(JoinStackPush, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    ca_.Branch(tmp8, &block9, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4}, &block10, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4});
  }
  ...
  if (block9.is_used()) {
    ...
    ca_.Branch(tmp15, &block12, std::vector<Node*>{phi_bb9_4}, &block13, std::vector<Node*>{phi_bb9_4});
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Branch(tmp21, &block18, std::vector<Node*>{phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4}, &block19, std::vector<Node*>{phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4});
  }
  ...
  if (block13.is_used()) {
    ...
    ca_.Branch(tmp27, &block21, std::vector<Node*>{phi_bb13_4}, &block22, std::vector<Node*>{phi_bb13_4});
  }
...
TNode<BoolT> JoinStackPushInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp31, &block20, std::vector<Node*>{}, &block21, std::vector<Node*>{});
  }
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp36 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kJoinStackPush, p_context, tmp0, p_receiver));
    tmp37 = False_0(state_);
    tmp38 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp36}, TNode<HeapObject>{tmp37});
    ca_.Branch(tmp38, &block23, std::vector<Node*>{}, &block24, std::vector<Node*>{});
  }
...
TF_BUILTIN(JoinStackPop, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp7 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp5});
    tmp8 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp6}, TNode<UintPtrT>{tmp7});
    ca_.Branch(tmp8, &block11, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4}, &block12, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4});
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp14, &block5, std::vector<Node*>{phi_bb11_4}, &block6, std::vector<Node*>{phi_bb11_4});
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp16, &block16, std::vector<Node*>{phi_bb5_4}, &block17, std::vector<Node*>{phi_bb5_4});
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Branch(tmp27, &block24, std::vector<Node*>{phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4}, &block25, std::vector<Node*>{phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4});
  }
...
void JoinStackPopInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp20 = CodeStubAssembler(state_).CallBuiltin(Builtins::kJoinStackPop, p_context, tmp0, p_receiver);
    ca_.Goto(&block18);
  }
...
TNode<FixedArray> StoreAndGrowFixedArray_JSReceiver_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<JSReceiver> p_element) {
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp7, &block13, std::vector<Node*>{}, &block14, std::vector<Node*>{});
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(tmp20, &block24, std::vector<Node*>{}, &block25, std::vector<Node*>{});
  }
