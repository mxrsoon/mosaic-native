...
TNode<Int32T> PerformPolymorphicCheck_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_expectedPolymorphicArray, TNode<Map> p_actualMap, TNode<Object> p_actualHandler) {
  ...
  if (block28.is_used()) {
    ...
    ca_.Branch(tmp10, &block26, std::vector<Node*>{phi_bb28_6}, &block27, std::vector<Node*>{phi_bb28_6});
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp13, &block30, std::vector<Node*>{phi_bb26_6}, &block31, std::vector<Node*>{phi_bb26_6});
  }
  ...
  if (block43.is_used()) {
    ...
    ca_.Branch(tmp21, &block45, std::vector<Node*>{phi_bb43_6}, &block46, std::vector<Node*>{phi_bb43_6});
  }
