...
void TypedArrayMerge_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_comparefn, TNode<FixedArray> p_source, TNode<UintPtrT> p_from, TNode<UintPtrT> p_middle, TNode<UintPtrT> p_to, TNode<FixedArray> p_target) {
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp10, &block16, std::vector<Node*>{phi_bb6_8, phi_bb6_9, phi_bb6_10, phi_bb6_10, phi_bb6_10}, &block17, std::vector<Node*>{phi_bb6_8, phi_bb6_9, phi_bb6_10, phi_bb6_10, phi_bb6_10});
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp23, &block23, std::vector<Node*>{phi_bb16_9, phi_bb16_10, phi_bb16_15, phi_bb16_16, phi_bb16_8, phi_bb16_8}, &block24, std::vector<Node*>{phi_bb16_9, phi_bb16_10, phi_bb16_15, phi_bb16_16, phi_bb16_8, phi_bb16_8});
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(tmp29, &block26, std::vector<Node*>{phi_bb7_8, phi_bb7_9, phi_bb7_10}, &block27, std::vector<Node*>{phi_bb7_8, phi_bb7_9, phi_bb7_10});
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp36, &block33, std::vector<Node*>{phi_bb26_8, phi_bb26_9, phi_bb26_10, phi_bb26_8, phi_bb26_8}, &block34, std::vector<Node*>{phi_bb26_8, phi_bb26_9, phi_bb26_10, phi_bb26_8, phi_bb26_8});
  }
  ...
  if (block33.is_used()) {
    ...
    ca_.Branch(tmp49, &block40, std::vector<Node*>{phi_bb33_8, phi_bb33_9, phi_bb33_10, phi_bb33_9, phi_bb33_9}, &block41, std::vector<Node*>{phi_bb33_8, phi_bb33_9, phi_bb33_10, phi_bb33_9, phi_bb33_9});
  }
  ...
  if (block40.is_used()) {
    ...
    ca_.Branch(tmp58, &block43, std::vector<Node*>{phi_bb40_8, phi_bb40_9, phi_bb40_10}, &block44, std::vector<Node*>{phi_bb40_8, phi_bb40_9, phi_bb40_10});
  }
  ...
  if (block43.is_used()) {
    ...
    ca_.Branch(tmp65, &block50, std::vector<Node*>{phi_bb43_8, phi_bb43_9, phi_bb43_10, phi_bb43_10, phi_bb43_10}, &block51, std::vector<Node*>{phi_bb43_8, phi_bb43_9, phi_bb43_10, phi_bb43_10, phi_bb43_10});
  }
  ...
  if (block44.is_used()) {
    ...
    ca_.Branch(tmp78, &block57, std::vector<Node*>{phi_bb44_8, phi_bb44_9, phi_bb44_10, phi_bb44_10, phi_bb44_10}, &block58, std::vector<Node*>{phi_bb44_8, phi_bb44_9, phi_bb44_10, phi_bb44_10, phi_bb44_10});
  }
  ...
  if (block27.is_used()) {
    ...
    ca_.Branch(tmp91, &block68, std::vector<Node*>{phi_bb27_8, phi_bb27_9, phi_bb27_10, phi_bb27_10, phi_bb27_10}, &block69, std::vector<Node*>{phi_bb27_8, phi_bb27_9, phi_bb27_10, phi_bb27_10, phi_bb27_10});
  }
  ...
  if (block68.is_used()) {
    ...
    ca_.Branch(tmp104, &block75, std::vector<Node*>{phi_bb68_8, phi_bb68_10, phi_bb68_15, phi_bb68_16, phi_bb68_9, phi_bb68_9}, &block76, std::vector<Node*>{phi_bb68_8, phi_bb68_10, phi_bb68_15, phi_bb68_16, phi_bb68_9, phi_bb68_9});
  }
...
TF_BUILTIN(TypedArrayMergeSort, CodeStubAssembler) {
  ...
  USE(parameter1);
  TNode<UintPtrT> parameter2 = UncheckedParameter<UintPtrT>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  TNode<UintPtrT> parameter3 = UncheckedParameter<UintPtrT>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  TNode<FixedArray> parameter4 = UncheckedParameter<FixedArray>(Descriptor::ParameterIndex<3>());
  USE(parameter4);
  TNode<JSTypedArray> parameter5 = UncheckedParameter<JSTypedArray>(Descriptor::ParameterIndex<4>());
  USE(parameter5);
  TNode<JSReceiver> parameter6 = UncheckedParameter<JSReceiver>(Descriptor::ParameterIndex<5>());
  USE(parameter6);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
USE(parameter1);
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp28, &block16, std::vector<Node*>{phi_bb18_15}, &block17, std::vector<Node*>{phi_bb18_15});
  }
...
tmp29 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp20, TNode<Object>(), tmp7, phi_bb16_15));
    ...
    tmp35 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp32});
    tmp36 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp34}, TNode<UintPtrT>{tmp35});
    ca_.Branch(tmp36, &block25, std::vector<Node*>{phi_bb16_15, phi_bb16_15, phi_bb16_15}, &block26, std::vector<Node*>{phi_bb16_15, phi_bb16_15, phi_bb16_15});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp47, &block32, std::vector<Node*>{phi_bb25_15, phi_bb25_15, phi_bb25_15}, &block33, std::vector<Node*>{phi_bb25_15, phi_bb25_15, phi_bb25_15});
  }
  ...
  if (block17.is_used()) {
    ...
    tmp55 = CodeStubAssembler(state_).CallBuiltin(Builtins::kTypedArrayMergeSort, parameter0, tmp26, tmp54, tmp9, tmp24, tmp7, tmp17);
  ...
  if (block37.is_used()) {
    ...
    ca_.Branch(tmp57, &block35, std::vector<Node*>{phi_bb37_15}, &block36, std::vector<Node*>{phi_bb37_15});
  }
  ...
  if (block35.is_used()) {
    ...
    ca_.Branch(tmp64, &block43, std::vector<Node*>{phi_bb35_15, phi_bb35_15, phi_bb35_15, phi_bb35_15}, &block44, std::vector<Node*>{phi_bb35_15, phi_bb35_15, phi_bb35_15, phi_bb35_15});
  }
