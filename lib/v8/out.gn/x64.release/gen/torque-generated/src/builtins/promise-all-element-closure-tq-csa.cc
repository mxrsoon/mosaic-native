...
TNode<Object> PromiseAllResolveElementClosure_PromiseAllWrapResultAsFulfilledFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_value, TNode<JSFunction> p_function, TorqueStructPromiseAllWrapResultAsFulfilledFunctor_0 p_wrapResultFunctor, bool p_hasResolveAndRejectClosures) {
  ...
  if (block24.is_used()) {
    ...
    ca_.Branch(tmp33, &block32, std::vector<Node*>{}, &block33, std::vector<Node*>{});
  }
  ...
  if (block32.is_used()) {
    ...
    ca_.Branch(tmp40, &block26, std::vector<Node*>{}, &block27, std::vector<Node*>{});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp47, &block40, std::vector<Node*>{}, &block41, std::vector<Node*>{});
  }
  ...
  if (block40.is_used()) {
    ...
    ca_.Branch(tmp55, &block43, std::vector<Node*>{}, &block44, std::vector<Node*>{});
  }
  ...
  if (block43.is_used()) {
    ...
    ca_.Branch(tmp60, &block45, std::vector<Node*>{}, &block46, std::vector<Node*>{});
  }
...
TNode<Object> PromiseAllResolveElementClosure_PromiseAllSettledWrapResultAsFulfilledFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_value, TNode<JSFunction> p_function, TorqueStructPromiseAllSettledWrapResultAsFulfilledFunctor_0 p_wrapResultFunctor, bool p_hasResolveAndRejectClosures) {
  ...
  if (block25.is_used()) {
    ...
    tmp52 = CodeStubAssembler(state_).CallBuiltin(Builtins::kFastCreateDataProperty, p_context, tmp49, tmp50, tmp51);
    tmp53 = CodeStubAssembler(state_).StringConstant("value");
    tmp54 = CodeStubAssembler(state_).CallBuiltin(Builtins::kFastCreateDataProperty, p_context, tmp49, tmp53, p_value);
    ...
    ca_.Branch(tmp60, &block40, std::vector<Node*>{}, &block41, std::vector<Node*>{});
  }
  ...
  if (block40.is_used()) {
    ...
    ca_.Branch(tmp68, &block43, std::vector<Node*>{}, &block44, std::vector<Node*>{});
  }
  ...
  if (block43.is_used()) {
    ...
    ca_.Branch(tmp73, &block45, std::vector<Node*>{}, &block46, std::vector<Node*>{});
  }
