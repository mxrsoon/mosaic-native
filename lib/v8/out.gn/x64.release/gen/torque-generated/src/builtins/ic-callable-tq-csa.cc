...
void CollectCallFeedback_0(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId) {
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp3, &block17, std::vector<Node*>{}, &block18, std::vector<Node*>{});
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp4, &block19, std::vector<Node*>{}, &block20, std::vector<Node*>{});
  }
  ...
  if (block20.is_used()) {
    ...
    ca_.Branch(tmp5, &block21, std::vector<Node*>{}, &block22, std::vector<Node*>{});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp12, &block27, std::vector<Node*>{}, &block28, std::vector<Node*>{});
  }
  ...
  if (block29.is_used()) {
    ...
    ca_.Branch(tmp18, &block31, std::vector<Node*>{}, &block32, std::vector<Node*>{});
  }
...
void CollectConstructFeedback_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_target, TNode<Object> p_newTarget, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId, compiler::CodeAssemblerLabel* label_ConstructGeneric, compiler::CodeAssemblerLabel* label_ConstructArray, compiler::TypedCodeAssemblerVariable<AllocationSite>* label_ConstructArray_parameter_0) {
  ...
  if (block12.is_used()) {
    ...
    ca_.Branch(tmp3, &block18, std::vector<Node*>{}, &block19, std::vector<Node*>{});
  }
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp4 = IsMegamorphic_0(state_, TNode<MaybeObject>{tmp2});
    ca_.Branch(tmp4, &block20, std::vector<Node*>{}, &block21, std::vector<Node*>{});
  }
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    tmp5 = IsUninitialized_0(state_, TNode<MaybeObject>{tmp2});
    ca_.Branch(tmp5, &block22, std::vector<Node*>{}, &block23, std::vector<Node*>{});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp7, &block24, std::vector<Node*>{}, &block25, std::vector<Node*>{});
  }
  ...
  if (block24.is_used()) {
    ...
    ca_.Branch(tmp9, &block26, std::vector<Node*>{}, &block27, std::vector<Node*>{});
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp10, &block28, std::vector<Node*>{}, &block29, std::vector<Node*>{});
  }
