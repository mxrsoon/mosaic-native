...
TNode<BoolT> IsSubstringAt_char8_char8_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr, TNode<IntPtrT> p_start) {
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp9, &block8, std::vector<Node*>{phi_bb10_11, phi_bb10_14}, &block9, std::vector<Node*>{phi_bb10_11, phi_bb10_14});
  }
  ...
  if (block8.is_used()) {
    ...
    ca_.Branch(tmp10, &block15, std::vector<Node*>{phi_bb8_11, phi_bb8_14}, &block16, std::vector<Node*>{phi_bb8_11, phi_bb8_14});
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp17, &block23, std::vector<Node*>{phi_bb16_11}, &block24, std::vector<Node*>{phi_bb16_11});
  }
