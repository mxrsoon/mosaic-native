...
TNode<Smi> TwoStringsToSlices_Smi_AbstractStringIndexOfFunctor_0(compiler::CodeAssemblerState* state_, TNode<String> p_s1, TNode<String> p_s2, TorqueStructAbstractStringIndexOfFunctor_0 p_f) {
  ...
  if (block8.is_used()) {
    ...
    ca_.Branch(tmp4, &block6, std::vector<Node*>{phi_bb8_5, phi_bb8_6}, &block7, std::vector<Node*>{phi_bb8_5, phi_bb8_6});
  }
  ...
  if (block59.is_used()) {
    ...
    ca_.Branch(tmp68, &block57, std::vector<Node*>{phi_bb59_3, phi_bb59_4, phi_bb59_5, phi_bb59_8, phi_bb59_9}, &block58, std::vector<Node*>{phi_bb59_3, phi_bb59_4, phi_bb59_5, phi_bb59_8, phi_bb59_9});
  }
  ...
  if (block110.is_used()) {
    ...
    ca_.Branch(tmp134, &block108, std::vector<Node*>{phi_bb110_3, phi_bb110_4, phi_bb110_5, phi_bb110_8, phi_bb110_9}, &block109, std::vector<Node*>{phi_bb110_3, phi_bb110_4, phi_bb110_5, phi_bb110_8, phi_bb110_9});
  }
...
TNode<Smi> AbstractStringIndexOf_char8_char8_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchString, TNode<Smi> p_fromIndex) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).SmiUntag(TNode<Smi>{p_fromIndex});
  ...
  if (block4.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{p_string.length}, TNode<IntPtrT>{p_searchString.length});
    tmp2 = CodeStubAssembler(state_).IntPtrLessThanOrEqual(TNode<IntPtrT>{phi_bb4_7}, TNode<IntPtrT>{tmp1});
    ca_.Branch(tmp2, &block2, std::vector<Node*>{phi_bb4_7}, &block3, std::vector<Node*>{phi_bb4_7});
  }
  ...
  if (block2.is_used()) {
    ...
    tmp3 = IsSubstringAt_char8_char8_0(state_, TorqueStructSlice_char8_ConstReference_char8_0{TNode<Object>{p_string.object}, TNode<IntPtrT>{p_string.offset}, TNode<IntPtrT>{p_string.length}, TorqueStructUnsafe_0{}}, TorqueStructSlice_char8_ConstReference_char8_0{TNode<Object>{p_searchString.object}, TNode<IntPtrT>{p_searchString.offset}, TNode<IntPtrT>{p_searchString.length}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb2_7});
    ca_.Branch(tmp3, &block6, std::vector<Node*>{phi_bb2_7}, &block7, std::vector<Node*>{phi_bb2_7});
  }
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6, &phi_bb6_7);
    tmp4 = CodeStubAssembler(state_).SmiTag(TNode<IntPtrT>{phi_bb6_7});
  ...
  if (block7.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb7_7}, TNode<IntPtrT>{tmp5});
...
TNode<Smi> AbstractStringIndexOf_char8_char16_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char16_ConstReference_char16_0 p_searchString, TNode<Smi> p_fromIndex) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2, &phi_bb2_7);
    tmp3 = IsSubstringAt_char8_char16_0(state_, TorqueStructSlice_char8_ConstReference_char8_0{TNode<Object>{p_string.object}, TNode<IntPtrT>{p_string.offset}, TNode<IntPtrT>{p_string.length}, TorqueStructUnsafe_0{}}, TorqueStructSlice_char16_ConstReference_char16_0{TNode<Object>{p_searchString.object}, TNode<IntPtrT>{p_searchString.offset}, TNode<IntPtrT>{p_searchString.length}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb2_7});
    ca_.Branch(tmp3, &block6, std::vector<Node*>{phi_bb2_7}, &block7, std::vector<Node*>{phi_bb2_7});
  }
...
TNode<Smi> AbstractStringIndexOf_char16_char8_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char16_ConstReference_char16_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchString, TNode<Smi> p_fromIndex) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2, &phi_bb2_7);
    tmp3 = IsSubstringAt_char16_char8_0(state_, TorqueStructSlice_char16_ConstReference_char16_0{TNode<Object>{p_string.object}, TNode<IntPtrT>{p_string.offset}, TNode<IntPtrT>{p_string.length}, TorqueStructUnsafe_0{}}, TorqueStructSlice_char8_ConstReference_char8_0{TNode<Object>{p_searchString.object}, TNode<IntPtrT>{p_searchString.offset}, TNode<IntPtrT>{p_searchString.length}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb2_7});
    ca_.Branch(tmp3, &block6, std::vector<Node*>{phi_bb2_7}, &block7, std::vector<Node*>{phi_bb2_7});
  }
...
TNode<Smi> AbstractStringIndexOf_char16_char16_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char16_ConstReference_char16_0 p_string, TorqueStructSlice_char16_ConstReference_char16_0 p_searchString, TNode<Smi> p_fromIndex) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2, &phi_bb2_7);
    tmp3 = IsSubstringAt_char16_char16_0(state_, TorqueStructSlice_char16_ConstReference_char16_0{TNode<Object>{p_string.object}, TNode<IntPtrT>{p_string.offset}, TNode<IntPtrT>{p_string.length}, TorqueStructUnsafe_0{}}, TorqueStructSlice_char16_ConstReference_char16_0{TNode<Object>{p_searchString.object}, TNode<IntPtrT>{p_searchString.offset}, TNode<IntPtrT>{p_searchString.length}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb2_7});
    ca_.Branch(tmp3, &block6, std::vector<Node*>{phi_bb2_7}, &block7, std::vector<Node*>{phi_bb2_7});
  }
