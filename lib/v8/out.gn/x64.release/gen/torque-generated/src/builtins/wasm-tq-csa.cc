...
TF_BUILTIN(WasmInt32ToHeapNumber, CodeStubAssembler) {
  ...
  TNode<Int32T> parameter0 = UncheckedParameter<Int32T>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(WasmTaggedNonSmiToInt32, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<HeapObject> parameter1 = UncheckedParameter<HeapObject>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(WasmTableInit, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<Uint32T> parameter0 = UncheckedParameter<Uint32T>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<Uint32T> parameter1 = UncheckedParameter<Uint32T>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  TNode<Uint32T> parameter2 = UncheckedParameter<Uint32T>(Descriptor::ParameterIndex<2>());
  USE(parameter2);
  TNode<Smi> parameter3 = UncheckedParameter<Smi>(Descriptor::ParameterIndex<3>());
  USE(parameter3);
  TNode<Smi> parameter4 = UncheckedParameter<Smi>(Descriptor::ParameterIndex<4>());
  USE(parameter4);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(WasmTableGet, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<IntPtrT> parameter0 = UncheckedParameter<IntPtrT>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<Int32T> parameter1 = UncheckedParameter<Int32T>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(WasmTableSet, CodeStubAssembler) {
  ...
  TNode<Int32T> parameter1 = UncheckedParameter<Int32T>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  TNode<Object> parameter2 = UncheckedParameter<Object>(Descriptor::ParameterIndex<2>());
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(WasmAllocateRtt, CodeStubAssembler) {
  ...
  TNode<IntPtrT> parameter0 = UncheckedParameter<IntPtrT>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<Map> parameter1 = UncheckedParameter<Map>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(WasmAllocateStructWithRtt, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<Map> parameter0 = UncheckedParameter<Map>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).LoadReference<Uint8T>(CodeStubAssembler::Reference{parameter0, tmp0});
    tmp2 = Convert_intptr_uint8_0(state_, TNode<Uint8T>{tmp1});
    tmp3 = CodeStubAssembler(state_).TimesTaggedSize(TNode<IntPtrT>{tmp2});
    tmp4 = CodeStubAssembler(state_).Allocate(TNode<IntPtrT>{tmp3}, CodeStubAssembler::AllocationFlag::kAllowLargeObjectAllocation);
    tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    std::tie(tmp6, tmp7) = UnsafeConstCast_Map_0(state_, TorqueStructReference_Map_0{TNode<Object>{tmp4}, TNode<IntPtrT>{tmp5}, TorqueStructUnsafe_0{}}).Flatten();
    CodeStubAssembler(state_).StoreReference<Map>(CodeStubAssembler::Reference{tmp6, tmp7}, parameter0);
...
TF_BUILTIN(WasmAllocateArrayWithRtt, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Uint32T>(CodeStubAssembler::Reference{tmp10, tmp11}, parameter1);
    CodeStubAssembler(state_).Return(tmp6);
  }
}
...
TF_BUILTIN(UintPtr53ToNumber, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<UintPtrT> parameter0 = UncheckedParameter<UintPtrT>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(WasmAtomicNotify, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = WasmBuiltinsAssembler(state_).LoadInstanceFromFrame();
    tmp1 = WasmBuiltinsAssembler(state_).LoadContextFromInstance(TNode<WasmInstanceObject>{tmp0});
    tmp2 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kUintPtr53ToNumber, TNode<Object>(), parameter0));
...
TF_BUILTIN(WasmI32AtomicWait64, CodeStubAssembler) {
  ...
  TNode<Int32T> parameter1 = UncheckedParameter<Int32T>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  TNode<IntPtrT> parameter2 = UncheckedParameter<IntPtrT>(Descriptor::ParameterIndex<2>());
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(WasmI64AtomicWait64, CodeStubAssembler) {
  ...
  TNode<UintPtrT> parameter0 = UncheckedParameter<UintPtrT>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<IntPtrT> parameter1 = UncheckedParameter<IntPtrT>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  TNode<IntPtrT> parameter2 = UncheckedParameter<IntPtrT>(Descriptor::ParameterIndex<2>());
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(WasmGetOwnProperty, CodeStubAssembler) {
  ...
  TNode<Object> parameter1 = UncheckedParameter<Object>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  TNode<Name> parameter2 = UncheckedParameter<Name>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
