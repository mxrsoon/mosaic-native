...
TF_BUILTIN(GetIteratorWithFeedback, CodeStubAssembler) {
  ...
  USE(parameter2);
  TNode<TaggedIndex> parameter3 = UncheckedParameter<TaggedIndex>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  ...
  if (block8.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).CallBuiltin(Builtins::kCallIteratorWithFeedback, parameter0, parameter1, phi_bb8_5, tmp6, parameter4);
...
TF_BUILTIN(CallIteratorWithFeedback, CodeStubAssembler) {
  ...
  USE(parameter2);
  TNode<Smi> parameter3 = UncheckedParameter<Smi>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  TNode<HeapObject> parameter4 = UncheckedParameter<HeapObject>(Descriptor::ParameterIndex<3>());
  USE(parameter4);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
