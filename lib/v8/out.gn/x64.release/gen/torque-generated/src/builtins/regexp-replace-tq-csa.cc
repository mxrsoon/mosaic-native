...
void RegExpReplaceCallableNoExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<String> p_string, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp8, &block10, std::vector<Node*>{phi_bb2_5, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6}, &block11, std::vector<Node*>{phi_bb2_5, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6});
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Branch(tmp19, &block17, std::vector<Node*>{phi_bb15_5, phi_bb15_6}, &block18, std::vector<Node*>{phi_bb15_5, phi_bb15_6});
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp34, &block24, std::vector<Node*>{phi_bb18_5}, &block25, std::vector<Node*>{phi_bb18_5});
  }
  ...
  if (block29.is_used()) {
    ...
    ca_.Branch(tmp50, &block35, std::vector<Node*>{phi_bb29_5, phi_bb29_6, phi_bb29_6, phi_bb29_6, phi_bb29_6, phi_bb29_6}, &block36, std::vector<Node*>{phi_bb29_5, phi_bb29_6, phi_bb29_6, phi_bb29_6, phi_bb29_6, phi_bb29_6});
  }
...
void RegExpReplaceCallableWithExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp7, &block12, std::vector<Node*>{phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4}, &block13, std::vector<Node*>{phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4});
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Branch(tmp24, &block21, std::vector<Node*>{phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4}, &block22, std::vector<Node*>{phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4});
  }
