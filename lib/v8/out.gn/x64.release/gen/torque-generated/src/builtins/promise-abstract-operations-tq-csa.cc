...
TF_BUILTIN(FulfillPromise, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<JSPromise> parameter1 = UncheckedParameter<JSPromise>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
...
TF_BUILTIN(RejectPromise, CodeStubAssembler) {
  ...
  TNode<Object> parameter2 = UncheckedParameter<Object>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  TNode<Oddball> parameter3 = UncheckedParameter<Oddball>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(NewPromiseCapability, CodeStubAssembler) {
  ...
  USE(parameter1);
  TNode<Oddball> parameter2 = UncheckedParameter<Oddball>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(PerformPromiseThen, CodeStubAssembler) {
  ...
  TNode<JSPromise> parameter1 = UncheckedParameter<JSPromise>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  TNode<HeapObject> parameter2 = UncheckedParameter<HeapObject>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  TNode<HeapObject> parameter3 = UncheckedParameter<HeapObject>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  TNode<HeapObject> parameter4 = UncheckedParameter<HeapObject>(Descriptor::ParameterIndex<3>());
  USE(parameter4);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
void InitContextSlot_PromiseCapabilitiesExecutorContext_PromiseCapabilitiesExecutorContext_PromiseCapability_PromiseCapability_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index, TNode<PromiseCapability> p_value) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Branch(tmp5, &block17, std::vector<Node*>{}, &block18, std::vector<Node*>{});
  }
