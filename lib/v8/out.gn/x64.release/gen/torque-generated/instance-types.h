...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_STRUCT_TYPE, 72) \
      ...
      V(MODULE_REQUEST_TYPE, 101) \
      V(PROMISE_CAPABILITY_TYPE, 102) \
      V(PROMISE_REACTION_TYPE, 103) \
      V(PROPERTY_DESCRIPTOR_OBJECT_TYPE, 104) \
      V(PROTOTYPE_INFO_TYPE, 105) \
      V(SCRIPT_TYPE, 106) \
      V(SOURCE_TEXT_MODULE_INFO_ENTRY_TYPE, 107) \
      V(STACK_FRAME_INFO_TYPE, 108) \
      V(STACK_TRACE_FRAME_TYPE, 109) \
      V(TEMPLATE_OBJECT_DESCRIPTION_TYPE, 110) \
      V(TUPLE2_TYPE, 111) \
    ...
    V(FIRST_DESCRIPTOR_ARRAY_TYPE, 152) \
      V(DESCRIPTOR_ARRAY_TYPE, 152) \
      V(STRONG_DESCRIPTOR_ARRAY_TYPE, 153) \
    V(LAST_DESCRIPTOR_ARRAY_TYPE, 153) \
    V(FIRST_MODULE_TYPE, 154) \
      V(SOURCE_TEXT_MODULE_TYPE, 154) \
      V(SYNTHETIC_MODULE_TYPE, 155) \
    V(LAST_MODULE_TYPE, 155) \
    V(FIRST_UNCOMPILED_DATA_TYPE, 156) \
      V(UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 156) \
      V(UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 157) \
    V(LAST_UNCOMPILED_DATA_TYPE, 157) \
    V(FIRST_WEAK_FIXED_ARRAY_TYPE, 158) \
      V(WEAK_FIXED_ARRAY_TYPE, 158) \
      V(TRANSITION_ARRAY_TYPE, 159) \
    V(LAST_WEAK_FIXED_ARRAY_TYPE, 159) \
    V(CELL_TYPE, 160) \
    V(CODE_TYPE, 161) \
    V(CODE_DATA_CONTAINER_TYPE, 162) \
    V(COVERAGE_INFO_TYPE, 163) \
    V(EMBEDDER_DATA_ARRAY_TYPE, 164) \
    V(FEEDBACK_METADATA_TYPE, 165) \
    V(FEEDBACK_VECTOR_TYPE, 166) \
    V(FILLER_TYPE, 167) \
    V(FREE_SPACE_TYPE, 168) \
    V(INTERNAL_CLASS_TYPE, 169) \
    V(INTERNAL_CLASS_WITH_STRUCT_ELEMENTS_TYPE, 170) \
    V(MAP_TYPE, 171) \
    V(ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE, 172) \
    V(PREPARSE_DATA_TYPE, 173) \
    V(PROPERTY_ARRAY_TYPE, 174) \
    V(PROPERTY_CELL_TYPE, 175) \
    V(SHARED_FUNCTION_INFO_TYPE, 176) \
    V(SMI_BOX_TYPE, 177) \
    V(SMI_PAIR_TYPE, 178) \
    V(SORT_STATE_TYPE, 179) \
    V(WASM_ARRAY_TYPE, 180) \
    V(WASM_CAPI_FUNCTION_DATA_TYPE, 181) \
    V(WASM_STRUCT_TYPE, 182) \
    V(WEAK_ARRAY_LIST_TYPE, 183) \
    V(WEAK_CELL_TYPE, 184) \
    V(FIRST_JS_RECEIVER_TYPE, 185) \
      V(JS_PROXY_TYPE, 185) \
      V(FIRST_JS_OBJECT_TYPE, 186) \
        V(JS_OBJECT_TYPE, 1057) \
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 186) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 186) \
            V(JS_GLOBAL_OBJECT_TYPE, 186) \
            V(JS_GLOBAL_PROXY_TYPE, 187) \
            V(JS_MODULE_NAMESPACE_TYPE, 188) \
        ...
        V(FIRST_JS_COLLECTION_ITERATOR_TYPE, 1058) \
          V(FIRST_JS_MAP_ITERATOR_TYPE, 1058) \
            V(JS_MAP_KEY_ITERATOR_TYPE, 1058) \
            V(JS_MAP_KEY_VALUE_ITERATOR_TYPE, 1059) \
            V(JS_MAP_VALUE_ITERATOR_TYPE, 1060) \
          V(LAST_JS_MAP_ITERATOR_TYPE, 1060) \
          V(FIRST_JS_SET_ITERATOR_TYPE, 1061) \
            V(JS_SET_KEY_VALUE_ITERATOR_TYPE, 1061) \
            V(JS_SET_VALUE_ITERATOR_TYPE, 1062) \
          V(LAST_JS_SET_ITERATOR_TYPE, 1062) \
        V(LAST_JS_COLLECTION_ITERATOR_TYPE, 1062) \
        V(FIRST_JS_ARRAY_BUFFER_VIEW_TYPE, 1063) \
          V(JS_DATA_VIEW_TYPE, 1063) \
          V(JS_TYPED_ARRAY_TYPE, 1064) \
        V(LAST_JS_ARRAY_BUFFER_VIEW_TYPE, 1064) \
        V(FIRST_JS_COLLECTION_TYPE, 1065) \
          V(JS_MAP_TYPE, 1065) \
          V(JS_SET_TYPE, 1066) \
        V(LAST_JS_COLLECTION_TYPE, 1066) \
        V(FIRST_JS_FUNCTION_OR_BOUND_FUNCTION_TYPE, 1067) \
          V(JS_BOUND_FUNCTION_TYPE, 1067) \
          V(JS_FUNCTION_TYPE, 1068) \
        V(LAST_JS_FUNCTION_OR_BOUND_FUNCTION_TYPE, 1068) \
        V(FIRST_JS_WEAK_COLLECTION_TYPE, 1069) \
          V(JS_WEAK_MAP_TYPE, 1069) \
          V(JS_WEAK_SET_TYPE, 1070) \
        V(LAST_JS_WEAK_COLLECTION_TYPE, 1070) \
        V(JS_ARRAY_TYPE, 1071) \
        V(JS_ARRAY_BUFFER_TYPE, 1072) \
        V(JS_ARRAY_ITERATOR_TYPE, 1073) \
        V(JS_ASYNC_FROM_SYNC_ITERATOR_TYPE, 1074) \
        V(JS_COLLATOR_TYPE, 1075) \
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 1076) \
        V(JS_DATE_TYPE, 1077) \
        V(JS_DATE_TIME_FORMAT_TYPE, 1078) \
        V(JS_DISPLAY_NAMES_TYPE, 1079) \
        V(JS_ERROR_TYPE, 1080) \
        V(JS_FINALIZATION_REGISTRY_TYPE, 1081) \
        V(JS_LIST_FORMAT_TYPE, 1082) \
        V(JS_LOCALE_TYPE, 1083) \
        V(JS_MESSAGE_OBJECT_TYPE, 1084) \
        V(JS_NUMBER_FORMAT_TYPE, 1085) \
        V(JS_PLURAL_RULES_TYPE, 1086) \
        V(JS_PROMISE_TYPE, 1087) \
        V(JS_REG_EXP_TYPE, 1088) \
        V(JS_REG_EXP_STRING_ITERATOR_TYPE, 1089) \
        V(JS_RELATIVE_TIME_FORMAT_TYPE, 1090) \
        V(JS_SEGMENT_ITERATOR_TYPE, 1091) \
        V(JS_SEGMENTER_TYPE, 1092) \
        V(JS_SEGMENTS_TYPE, 1093) \
        V(JS_STRING_ITERATOR_TYPE, 1094) \
        V(JS_V8_BREAK_ITERATOR_TYPE, 1095) \
        V(JS_WEAK_REF_TYPE, 1096) \
        V(WASM_EXCEPTION_OBJECT_TYPE, 1097) \
        V(WASM_GLOBAL_OBJECT_TYPE, 1098) \
        V(WASM_INSTANCE_OBJECT_TYPE, 1099) \
        V(WASM_MEMORY_OBJECT_TYPE, 1100) \
        V(WASM_MODULE_OBJECT_TYPE, 1101) \
        V(WASM_TABLE_OBJECT_TYPE, 1102) \
      V(LAST_JS_OBJECT_TYPE, 1102) \
    V(LAST_JS_RECEIVER_TYPE, 1102) \
  V(LAST_HEAP_OBJECT_TYPE, 1102) \
...
#define TORQUE_DEFINED_FIXED_INSTANCE_TYPE_LIST(V) \
  ...
  V(WASM_CAPI_FUNCTION_DATA_TYPE, WasmCapiFunctionData, wasm_capi_function_data) \
...
#define TORQUE_DEFINED_MAP_CSA_LIST_GENERATOR(V, _) \
  ...
  V(_, WasmCapiFunctionDataMap, wasm_capi_function_data_map, WasmCapiFunctionData) \
