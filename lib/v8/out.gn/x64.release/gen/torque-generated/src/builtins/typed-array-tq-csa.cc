...
TF_BUILTIN(LoadTypedElement_Int32Elements_0, CodeStubAssembler) {
  ...
  TNode<JSTypedArray> parameter0 = UncheckedParameter<JSTypedArray>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<UintPtrT> parameter1 = UncheckedParameter<UintPtrT>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(StoreTypedElementNumeric_Int32Elements_0, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<JSTypedArray> parameter1 = UncheckedParameter<JSTypedArray>(Descriptor::ParameterIndex<0>());
  USE(parameter1);
  TNode<UintPtrT> parameter2 = UncheckedParameter<UintPtrT>(Descriptor::ParameterIndex<1>());
  USE(parameter2);
  TNode<Numeric> parameter3 = UncheckedParameter<Numeric>(Descriptor::ParameterIndex<2>());
  USE(parameter3);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
